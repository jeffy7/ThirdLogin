...
- (void)viewDidLoad
{
    ...
    [btn10 setTitle:@"服务器端签名微信支付" forState:UIControlStateNormal];
    btn10.titleLabel.font = [UIFont systemFontOfSize:14];
    [btn10 setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [btn10 setFrame:CGRectMake(10, 285, 145, 40)];
    [btn10 addTarget:self action:@selector(sendPay) forControlEvents:UIControlEventTouchUpInside];
    [footView addSubview:btn10];

    UIButton *btn11 = [UIButton buttonWithType:UIButtonTypeRoundedRect];
    [btn11 setTitle:@"APP端签名微信支付" forState:UIControlStateNormal];
    btn11.titleLabel.font = [UIFont systemFontOfSize:14];
    [btn11 setTitleColor:[UIColor blackColor] forState:UIControlStateNormal];
    [btn11 setFrame:CGRectMake(165, 285, 145, 40)];
    [btn11 addTarget:self action:@selector(sendPay2) forControlEvents:UIControlEventTouchUpInside];
    [footView addSubview:btn11];
