...
//    [WeiboSDK sendRequest:request];
    ...
    [params setObject:@"我就是小宝" forKey:@"status"];
    AppDelegate *myDelegate =(AppDelegate*)[[UIApplication sharedApplication] delegate];
    [params setObject:myDelegate.wbtoken forKey:@"access_token"];
//
    UIImage *image = [UIImage imageNamed:@"800.jpeg"];
    [params setObject:image forKey:@"pic"];
    
//    [WBHttpRequest requestWithAccessToken:myDelegate.wbtoken url:@"statuses/upload.json" httpMethod:@"POST" params:params delegate:self withTag:nil];
    [WBHttpRequest requestWithURL:@"https://upload.api.weibo.com/2/statuses/upload.json" httpMethod:@"POST" params:params delegate:self withTag:nil];
